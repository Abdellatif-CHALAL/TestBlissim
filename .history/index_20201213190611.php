                    ...
                    echo "<div class='col-md-12'>
                            ...
                            <h2 class='h5 pl-1 pt-1 pb-1'><p class='pl-3 pt-3 text-secondary text-decoration-none'>$titre</p></h2>
                                ...
                                <div class='form-group'>
                                  ...
                                  <input type='textarea' rows='2' class='form-control' id='commentaire' placeholder='commentaire' name='commentaire'>
                                </div>
                                <input type='hidden' class='form-control' id='idProduit' value='$id' name='idProduit'>
